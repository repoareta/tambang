...
<div class="d-flex align-items-stretch flex-shrink-0">
	...
	<div class="d-flex align-items-center ms-1 ms-lg-3">
		...
		@include('layouts.topbar.partials._notifications-menu')
	...
	<div class="d-flex align-items-center ms-1 ms-lg-3">
		...
		@include('layouts.topbar.partials._quick-links-menu')
		<!--end::Menu wrapper-->
	</div>
	<!--end::Quick links-->
	<!--begin::User-->
	<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
		...
		@include('layouts.topbar.partials._user-menu')
